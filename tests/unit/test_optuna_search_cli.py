...
class TestOptunaSearchParse:
    def test_defaults(self, tiny_model_config_name: str) -> None:
    ...
    def test_entry_flags_roundtrip(self, tiny_model_config_name: str) -> None:
    ...
    def test_runconfig_flags_share_the_parser(
    ...
    def test_invalid_metric_exits_with_choices(
        self, tiny_model_config_name: str
    ) -> None:
